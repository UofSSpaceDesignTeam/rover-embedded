...
*/
    ...
    int sensorValue6 = analogRead(pin);
    delay(1);

    int sensorValue7 = analogRead(pin);
    delay(1);

    int sensorValue8 = analogRead(pin);
    delay(1);

    int sensorValue9 = analogRead(pin);
    delay(1);

    int sensorValue10 = analogRead(pin);
    delay(1);

     int sensorValue11 = analogRead(pin);
    delay(1);

    int sensorValue12 = analogRead(pin);
    delay(1);

    int sensorValue13 = analogRead(pin);
    delay(1);

    int sensorValue14 = analogRead(pin);
    delay(1);

    int sensorValue15 = analogRead(pin);
    delay(1);

    int sensorValue16 = analogRead(pin);
    delay(1);

    int sensorValue17 = analogRead(pin);
    delay(1);

    int sensorValue18 = analogRead(pin);
    delay(1);

    int sensorValue19 = analogRead(pin);
    delay(1);

    int sensorValue20 = analogRead(pin);
    delay(1);

    int totSensorValue = sensorValue1 + sensorValue2 + sensorValue3 + sensorValue4 + sensorValue5 + sensorValue6 + sensorValue7 + sensorValue8 
    + sensorValue9 + sensorValue10 + sensorValue11 + sensorValue12 + sensorValue13 + sensorValue14 + sensorValue15 + sensorValue16 + sensorValue17 + sensorValue18 + sensorValue19 + sensorValue20;
  
  
  float avgSensorValue = totSensorValue/20; //analog read value is averaged to lessen noise
